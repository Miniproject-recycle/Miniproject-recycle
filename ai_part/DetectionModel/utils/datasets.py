...
#python detect.py --device cpu --weights runs/train/yolor_p6.pt --names data/test_newconn.names --source inference/images --conf-thres 0.1
import glob
import math
import os
import random
...
class LoadImages:  # for inference
    ...
    def __next__(self):
        ...
        if self.video_flag[self.count]:
            ...
            # Read image
            self.count += 1
            # Handle unicode path for cv2.imread
            import numpy as np
            try:
                img0 = cv2.imread(path)  # BGR
                if img0 is None:
                    # Try with numpy fromfile for unicode path
